            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                reusableTextField(
                  ...
                  helperText: 'password must include [a-z] [A-Z] [0-9] Special character '
                ),
                const SizedBox(
                  height: 20,
                ),
                ...
                firebaseUIButton(context, "Sign Up", () {
                 ...
                 if(_key.currentState!.validate()){
                   ...
                   Get.snackbar('Error', 'Please set Strong Password ',backgroundColor: Colors.red,colorText: Colors.white);
                 }
