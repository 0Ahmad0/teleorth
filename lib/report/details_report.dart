...
class DetailsReport{
  ...
  static  String convertSymptoms(List symptoms){
    ...
    symptoms.forEach((element) {
      if(element.contains("Do you smoke")) convert+="Smoking\n";
      else if(element.contains("Do you have pain")) convert+="Pain\n";
      else if(element.contains("Do you have Ecchymosis")) convert+="Ecchymosis\n";
      else if(element.contains("Do you have an osteoporosis")) convert+="Osteoporosis\n";
      else if(element.contains("Do you have Absent pulse")) convert+="Absent pulse\n";
      else if(element.contains("Do you have discolouration of the skin")) convert+="Discolouration of the skin\n";
      else if(element.contains("Do you have a deformity of the ankle")) convert+="Deformity of the ankle\n";
      else if(element.contains("Do you have joint swelling?")) convert+="joint swelling\n";
      else if(element.contains("Enter the weight in Kg and the height in cm")) convert+="Overweight\n";
      else if(element.contains("Do you have stiffness in your ankle")) convert+="Stiffness in ankle\n";
      else if(element.contains("Do you have difficulty and pain while walkin")) convert+="Difficulty and pain while walking\n";
      else if(element.contains("Do you have bruising")) convert+="Bruising\n";
      else if(element.contains("Do you have swelling accompanied by pain right away")) convert+="Swelling accompanied by pain\n";
      else if(element.contains("Are you twisted your ankle")) convert+=" Ankle twist\n";
      else convert+="${element}\n";
    });
    return convert;
  }
}