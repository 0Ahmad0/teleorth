...
final String image1 = "patient/h2.jpg";//"patient/25bd10b6-fc2d-47fc-bc41-d705c87d3d337434439872645250109.jpg";//"lib/temp/h.jpg";//"images/broccoli.jpg";
final String image2 = "patient/25bd10b6-fc2d-47fc-bc41-d705c87d3d337434439872645250109.jpg";//"patient/h2.jpg";//"C:/Users/User/Pictures/Saved Pictures/h2.jpg";//"images/carrots.jpg";
            ...
            child: FlatButton(
              onPressed: () {
                ...
                setState(() {
                  ...
                  image = image1;//imageList[_random.nextInt(imageList.length)];
                });
              },
              child: Text(
                "Load Image",
